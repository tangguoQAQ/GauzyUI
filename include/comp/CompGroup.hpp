...
namespace gauzy::comp
{
    ...
    {
    public:
        CompGroup(const CompGroup& other) = delete;
        CompGroup(CompGroup&& other) noexcept = delete;
        CompGroup& operator=(const CompGroup& other) = delete;
        CompGroup& operator=(CompGroup&& other) noexcept = delete;
    ...
    template <typename... Comps>
    void CompGroup::add(Comps&&... newChildren)
    {
